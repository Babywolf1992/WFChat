...
- (void)viewDidLoad {
    ...
    //获取服务器好友列表
    [[[WFXMPPManager sharedInstance] xmppRoster] fetchRoster];
...
- (void)rosterChange
{
    self.friendsList = [NSMutableArray arrayWithArray:[WFXMPPManager sharedInstance].xmppRosterMemoryStorage.unsortedUsers];
